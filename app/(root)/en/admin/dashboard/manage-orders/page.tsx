...
import ShowAllOrdersAdmin from '@/components/Orders/ShowAllOrdersAdmin'
import { fetchAllOrders } from '@/lib/actions/OrderActions/OrderActions';
...
async function getData({
    ...
    let res = await fetchAllOrders({ pageNo, pageSize });
            ...
            <div className="flex w-full justify-between items-center flex-wrap gap-4 px-4 md:px-24 py-4">
                ...
                <div className="flex gap-4 flex-wrap">
                    <Link className='px-4 flex justify-center items-center py-1.5 bg-blue-700 rounded-md text-sm text-white'
                        href={{
                            pathname: '/en/admin/dashboard/manage-orders',
                            query: {

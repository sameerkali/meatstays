...
const Section8ProductCard = ( data :any) => {
    ...
    return (
            <div>
                <div className={`max-w-fit  md:mx-4 border border-red-200 shadow-md hover:shadow-xl min-h-[3rem] duration-200 rounded-lg p-2 ${poppins.className}`}>
...
export default Section8ProductCard;

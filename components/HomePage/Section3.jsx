...
const srevicesCards = [
  {
    src: "/servicesHome/img3.jpg",
    href: "/",
    title: "FRESH HIMALAYAN MEAT",
  ...
  {
    src: "/servicesHome/2.jpeg",
    href: "/",
    title: "GET MEAT DELIVERED TO YOUR DOORS",
      ...
      <div className="">
        <div className="w-full border border-gray-300 dark:bg-red-600 shadow-md bg-gray-200 flex flex-col md:flex-row justify-center items-center p-3 rounded-lg my-8 gap-5 md:gap-10">
          ...
          <div className="p-2 md:p-5 flex-[60%]">
            ...
            <p className="text-sm  font-[400] mb-5">{srevicesCards[0].desc}</p>
            <Link
